...
int main(int argc, char* argv[]){
  ...
  for (it=0; it<nt; it++) {
    ...
    update_stress_vf_tti(vz_ff, vx_ff, vz_vv, vx_vv, sxx_vf, sxz_vf, szz_vf, ro, c11, c13,   \
                     c33, c55, c15, c35, t12, dtx, dtz, nzpad, nxpad);


    update_stress_fv_tti(vz_ff, vx_ff, vz_vv, vx_vv, sxx_fv, sxz_fv, szz_fv, ro, c11, c13,   \
                     c33, c55, c15, c35, t21, dtx, dtz, nzpad, nxpad);
